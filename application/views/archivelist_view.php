<?php 
$attributes = array('id' => 'frmarchivelist','name' => 'frmarchivelist');
echo form_open_multipart('archive',$attributes); ?> 
...
<!--  <?=$message?> -->
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title text-center" style="font-size:20px;font-weight: bold;padding:20px;">Archive List</h3>
    </div>
    <div class="panel-body">
      ...
      <td><input type="button" value="Delete" class="btn btn-danger" onClick="deleteObj('frmarchivelist',<?=$row->c_id?>,'deletearchive')"/></td>
      </tr>
      <?php
      }
      ?>
