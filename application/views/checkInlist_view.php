<?php 
$attributes = array('id' => 'frmcheckInlist','name' => 'frmcheckInlist');
echo form_open_multipart('checkInlist',$attributes); ?> 
...
<!--  <?=$message?> -->
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title text-center" style="font-size:20px;font-weight: bold;padding:20px;">Check In List</h3>
    </div>
   ...
   <!--    <td><input type="button" value="Delete" class="btn btn-danger" onClick="deleteObj('frmcheckInlist',<?=$row->c_id?>,'deleteCheckinlist')"/></td> -->
      </tr>
      <?php
      }
      ?>
